...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messId = (EditText)findViewById(R.id.messIdTextView);
        messPassword = (EditText)findViewById(R.id.hostelPass);
    ...
    public void doMessLogin(View view) {
    ...
    private JSONObject buidJsonObject() throws JSONException {
        ...
        jsonObject.accumulate("hostelid",messId.getText().toString());
        jsonObject.accumulate("password",messPassword.getText().toString());
